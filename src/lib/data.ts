...
export const dsProjects: Project[] = [
  {
    id: 1,
    ...
    githubUrl:
      "https://github.com/Viyathmaranlini/sri-lanka-economic-analysis",
  },
];
...
export const webProjects: Project[] = [
  {
    ...
    description:
      "🌍 The Colombo Real-time Air Quality Monitoring Dashboard",
    image: "/projects/Air Quality.jpeg",
    tags: ["Blade", "PHP", "JavaScript", "HTML", "CSS"],
    liveUrl: "https://example.com",
    githubUrl:
      "https://github.com/Viyathmaranlini/Air-Quality-Monitoring",
  },
  {
    id: 6,
    title: "Haritha TV",
  ...
  },
  {
    ...
    title: "Organic Food",
    description:
      "🌿 Green Harvest - A fully responsive website for showcasing organic food products, designed with a clean and modern aesthetic.",
...
export const timeline: TimelineEntry[] = [
  {
    ...
    description:
      "Contributed to the marketing campaign for AlgoXplore 1.0, promoting the hackathon across social media and university channels to drive participant registrations.",
    type: "volunteer",
  ...
  },
  {
    ...
    description:
      "Helped organize and coordinate IEEE Day 2023 event activities, managing the program schedule and ensuring smooth execution of sessions.",
    type: "volunteer",
  ...
  },
  {
    ...
    title: "Member",
    company:
      "Mathematics and Statistics Circle - NSBM Green University",
    description:
...
export const skills: Skill[] = [
  ...
  { name: "Pandas", icon: "🐼", level: 75, category: "other" },
  { name: "Scikit-learn", icon: "🔬", level: 65, category: "other" },
  { name: "Plotly", icon: "📈", level: 70, category: "other" },
];